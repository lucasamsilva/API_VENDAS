...
import com.lucasdev.domain.Pagamento;
import com.lucasdev.domain.PagamentoComBoleto;
import com.lucasdev.domain.PagamentoComCartao;
import com.lucasdev.domain.Pedido;
import com.lucasdev.domain.Produto;
import com.lucasdev.domain.enums.EstadoPagamento;
import com.lucasdev.domain.enums.Perfil;
...
import com.lucasdev.repositories.EnderecoRepository;
import com.lucasdev.repositories.EstadoRepository;
import com.lucasdev.repositories.ItemPedidoRepository;
import com.lucasdev.repositories.PagamentoRepository;
import com.lucasdev.repositories.PedidoRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "lucasandreim@hotmail.com", "36378912377", TipoCliente.PESSOA_FISICA, pe.encode("123"));
		Cliente cli2 = new Cliente(null, "Ana Costa", "moraes.andrei@ifsp.edu.br", "17655560153", TipoCliente.PESSOA_FISICA, pe.encode("123"));
		cli2.addPerfil(Perfil.ADMIN);
		
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		cli2.getTelefones().addAll(Arrays.asList("5123124123", "12546123"));
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 203", "Jardins", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "3877012", cli1, c2);
		Endereco e3 = new Endereco(null, "Rua Tiradentes", "1359", "Creche", "Costa Rica", "16202024", cli2, c1);
